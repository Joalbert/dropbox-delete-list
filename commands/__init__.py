...
def print_out_directory(directory: tuple) -> None:
    """ print out list directory and files if any,
        data is passed as followed item 0 files and
        item 1 directories."""
...
def remove_files(*, directory: Tuple[Iterable, Iterable],
                 filenames_to_be_kept: Iterable[str],
